...
const KEYS = {
  ...
  // Modular Pages Keys
  LIFE_PAGES: 'gh_life_pages_v1',
  SOCIAL_PAGES: 'gh_social_pages_v1',
  SELF_OBS_PAGES: 'gh_self_obs_pages_v1',
  LEARNING_KNOWLEDGE: 'gh_learn_know_v1',
  LEARNING_SKILLS: 'gh_learn_skill_v1',
};
...
export const StorageService = {
  ...
  getProfile: (): UserProfile => {
    try {
      ...
      return data ? JSON.parse(data) : { name: 'Architect', status: 'Ready for input.' };
    } catch { return { name: 'Architect', status: 'Ready for input.' }; }
  },
