...
import { ListTodo, BookOpen, Map, Users, LineChart, StickyNote, Eye } from 'lucide-react';
...
const MODULES = [
  ...
  { id: 'learning', title: 'Learning System', desc: 'Knowledge & Skills', icon: BookOpen, color: 'text-blue-500 border-blue-500/20 bg-blue-500/10', path: '/learning' },
  { id: 'life', title: 'Life Planning', desc: 'Vision & Milestones', icon: Map, color: 'text-gold border-gold/20 bg-gold/10', path: '/life' },
  { id: 'social', title: 'Social CRM', desc: 'Network & Events', icon: Users, color: 'text-purple-500 border-purple-500/20 bg-purple-500/10', path: '/social' },
...
export const Dashboard: React.FC = () => {
  ...
  const [profile, setProfile] = useState({ name: 'Architect', status: 'Ready for input.' });
  ...
  useEffect(() => {
    ...
    // Random Quote (Daily randomization based on date seed could be added, but simple random on load is often better for variety)
