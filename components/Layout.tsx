...
import { LayoutGrid, ListTodo, PieChart, Compass, Users, UserCircle, BookOpen, Eye, Settings, X, Download, Upload, Check } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { id: 'learning', icon: BookOpen, label: 'Learn', path: '/learning' },
  { id: 'life', icon: Compass, label: 'Life', path: '/life' },
...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `greenhouse_backup_${new Date().toISOString().slice(0,10)}.json`;
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-400">
                  Greenhouse OS stores data locally. To sync between Phone and PC, export the file from one device and import it on the other.
                </p>
